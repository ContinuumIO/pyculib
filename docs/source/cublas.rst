...
All functions are accessed through the :class:`pycudalib.blas.Blas` class:

.. autoclass:: pycudalib.blas.Blas

BLAS Level 1
------------

.. py:method:: pycudalib.blas.Blas.nrm2(x)
...
.. py:method:: pycudalib.blas.Blas.dot(x, y)
...
.. py:method:: pycudalib.blas.Blas.dotc(x, y)
...
.. py:method:: pycudalib.blas.Blas.scal(alpha, x)
...
.. py:method:: pycudalib.blas.Blas.axpy(alpha, x)
...
.. py:method:: pycudalib.blas.Blas.amax(x)
...
.. py:method:: pycudalib.blas.Blas.amin(x)
...
.. py:method:: pycudalib.blas.Blas.asum(x)
...
.. py:method:: pycudalib.blas.Blas.rot(x, y, c, s)
...
.. py:method:: pycudalib.blas.Blas.rotg(a, b)
...
.. py:method:: pycudalib.blas.Blas.rotm(x, y, param)
...
.. py:method:: pycudalib.blas.Blas.rotmg(d1, d2, x1, y1)
...
.. py:method:: pycudalib.blas.Blas.gbmv(trans, m, n, kl, ku, alpha, A, x, beta, y)

    banded matrix-vector multiplication `y = alpha * op(A) * x + beta * y` where
    `A` has `kl` sub-diagonals and `ku` super-diagonals.

.. py:method:: pycudalib.blas.Blas.gemv(trans, m, n, alpha, A, x, beta, y)

    matrix-vector multiplication `y = alpha * op(A) * x + beta * y`

.. py:method:: pycudalib.blas.Blas.trmv(uplo, trans, diag, n, A, x)

    triangular matrix-vector multiplication `x = op(A) * x`

.. py:method:: pycudalib.blas.Blas.tbmv(uplo, trans, diag, n, k, A, x)

    triangular banded matrix-vector `x = op(A) * x`

.. py:method:: pycudalib.blas.Blas.tpmv(uplo, trans, diag, n, AP, x)

    triangular packed matrix-vector multiplication `x = op(A) * x`

.. py:method:: pycudalib.blas.Blas.trsv(uplo, trans, diag, n, A, x)

    Solves the triangular linear system with a single right-hand-side.
    `op(A) * x = b`

.. py:method:: pycudalib.blas.Blas.tpsv(uplo, trans, diag, n, AP, x)

    Solves the packed triangular linear system with a single right-hand-side.
    `op(A) * x = b`

.. py:method:: pycudalib.blas.Blas.tbsv(uplo, trans, diag, n, k, A, x)

    Solves the triangular banded linear system with a single right-hand-side.
    `op(A) * x = b`

.. py:method:: pycudalib.blas.Blas.symv(uplo, n, alpha, A, x, beta, y)

    symmetric matrix-vector multiplication `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.hemv(uplo, n, alpha, A, x, beta, y)

    Hermitian matrix-vector multiplication `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.sbmv(uplo, n, k, alpha, A, x, beta, y)

    symmetric banded matrix-vector multiplication  `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.hbmv(uplo, n, k, alpha, A, x, beta, y)

    Hermitian banded matrix-vector multiplication  `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.spmv(uplo, n, alpha, AP, x, beta, y)

    symmetric packed matrix-vector multiplication `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.hpmv(uplo, n, alpha, AP, x, beta, y)

    Hermitian packed matrix-vector multiplication `y = alpha * A * x + beta * y`

.. py:method:: pycudalib.blas.Blas.ger(m, n, alpha, x, y, A)

    the rank-1 update `A := alpha * x * y ** T + A`

.. py:method:: pycudalib.blas.Blas.geru(m, n, alpha, x, y, A)

    the rank-1 update `A := alpha * x * y ** T + A`

.. py:method:: pycudalib.blas.Blas.gerc(m, n, alpha, x, y, A)

    the rank-1 update `A := alpha * x * y ** H + A`

.. py:method:: pycudalib.blas.Blas.syr(uplo, n, alpha, x, A)

    symmetric rank 1 operation `A := alpha * x * x ** T + A`

.. py:method:: pycudalib.blas.Blas.her(uplo, n, alpha, x, A)

    hermitian rank 1 operation  `A := alpha * x * x ** H + A`

.. py:method:: pycudalib.blas.Blas.spr(uplo, n, alpha, x, AP)

    the symmetric rank 1 operation `A := alpha * x * x ** T + A`

.. py:method:: pycudalib.blas.Blas.hpr(uplo, n, alpha, x, AP)

    hermitian rank 1 operation `A := alpha * x * x ** H + A`

.. py:method:: pycudalib.blas.Blas.syr2(uplo, n, alpha, x, y, A)

    symmetric rank-2 update `A = alpha * x * y ** T + y * x ** T + A`

.. py:method:: pycudalib.blas.Blas.her2(uplo, n, alpha, x, y, A)

    Hermitian rank-2 update `A = alpha * x * y ** H + alpha * y * x ** H + A`

.. py:method:: pycudalib.blas.Blas.spr2(uplo, n, alpha, x, y, A)

    packed symmetric rank-2 update `A = alpha * x * y ** T + y * x ** T + A`

.. py:method:: pycudalib.blas.Blas.hpr2(uplo, n, alpha, x, y, A)
...
.. py:method:: pycudalib.blas.Blas.gemm(transa, transb, m, n, k, alpha, A, B, beta, C)

    matrix-matrix multiplication `C = alpha * op(A) * op(B) + beta * C`

.. py:method:: pycudalib.blas.Blas.syrk(uplo, trans, n, k, alpha, A, beta, C)

    symmetric rank- k update `C = alpha * op(A) * op(A) ** T + beta * C`

.. py:method:: pycudalib.blas.Blas.herk(uplo, trans, n, k, alpha, A, beta, C)

    Hermitian rank- k update `C = alpha * op(A) * op(A) ** H + beta * C`

.. py:method:: pycudalib.blas.Blas.symm(side, uplo, m, n, alpha, A, B, beta, C)
...
.. py:method:: pycudalib.blas.Blas.hemm(side, uplo, m, n, alpha, A, B, beta, C)
...
.. py:method:: pycudalib.blas.Blas.trsm(side, uplo, trans, diag, m, n, alpha, A, B)
...
.. py:method:: pycudalib.blas.Blas.trmm(side, uplo, trans, diag, m, n, alpha, A, B, C)
...
.. py:method:: pycudalib.blas.Blas.dgmm(side, m, n, A, x, C)
...
.. py:method:: pycudalib.blas.Blas.geam(transa, transb, m, n, alpha, A, beta, B, C)
