...
accessed through the :class:`pycudalib.sparse.Sparse` class:

.. autoclass:: pycudalib.sparse.Sparse
...
Pycudalib. However, it is often necessary to provide a *matrix descriptor* to
...
:py:meth:`pycudalib.sparse.Sparse.matdescr` method:

.. py:method:: pycudalib.sparse.Sparse.matdescr(indexbase, diagtype, fillmode, matrixtype)
   ...
   :param indexbase: Optional. 0 for 0-based indexing, or 1 for 1-based
                     ...
                     :py:class:`pycudalib.sparse.Sparse` constructor is
                     used instead.
...
Many of the methods of the :class:`pycudalib.sparse.Sparse` class accept
...
:py:meth:`pycudalib.sparse.Sparse.csrgemm_ez`), accept an instance of the
:class:`pycudalib.sparse.CudaSparseMatrix` class:

.. py:class:: pycudalib.sparse.CudaSparseMatrix()
...
.. automethod:: pycudalib.sparse.bsr_matrix

.. automethod:: pycudalib.sparse.csr_matrix

.. automethod:: pycudalib.sparse.csc_matrix

BLAS Level 1
------------

.. py:method:: pycudalib.sparse.Sparse.axpyi(alpha, xVal, xInd, y)
...
.. py:method:: pycudalib.sparse.Sparse.doti(xVal, xInd, y)
...
.. py:method:: pycudalib.sparse.Sparse.dotci(xVal, xInd, y)
...
.. py:method:: pycudalib.sparse.Sparse.gthr(y, xVal, xInd)
...
.. py:method:: pycudalib.sparse.Sparse.gthrz(y, xVal, xInd)
...
.. py:method:: pycudalib.sparse.Sparse.roti(xVal, xInd, y, c, s)
...
.. py:method:: pycudalib.sparse.Sparse.sctr(xVal, xInd, y)
...
* descr, descrA, descrB -- (descriptor) Matrix descriptor. An appropriate
  ...
  :py:meth:`pycudalib.sparse.Sparse.matdescr`. `descr` only applies to the
...
.. py:method:: pycudalib.sparse.Sparse.bsrmv_matrix(dir, trans, alpha, descr, bsrmat, x, beta, y)
...
.. py:method:: pycudalib.sparse.Sparse.bsrmv(dir, trans, mb, nb, nnzb, alpha, descr, bsrVal, bsrRowPtr, bsrColInd, blockDim, x, beta, y)

   Matrix-vector multiplication `y = alpha * op(A) * x + beta * y` with a
   BSR-format matrix. This function accepts the individual arrays that make up
   the structure of a BSR matrix - if a
   :class:`pycudalib.sparse.CudaBSRMatrix` instance is to hand, it is
...
.. py:method:: pycudalib.sparse.Sparse.bsrxmv(dir, trans, sizeOfMask, mb, nb, nnzb, alpha, descr, bsrVal, bsrMaskPtr, bsrRowPtr, bsrEndPtr, bsrColInd, blockDim, x, beta, y)
...
.. py:method:: pycudalib.sparse.Sparse.csrmv(trans, m, n, nnz, alpha, descr, csrVal, csrRowPtr, csrColInd, x, beta, y)
...
.. py:method:: pycudalib.sparse.Sparse.csrsv_analysis(trans, m, nnz, descr, csrVal, csrRowPtr, csrColInd)
...
.. py:method:: pycudalib.sparse.Sparse.csrsv_solve(trans, m, alpha, descr, csrVal, csrRowPtr, csrColInd, info, x, y)
...
.. py:method:: pycudalib.sparse.Sparse.csrmm(transA, m, n, k, nnz, alpha, descrA, csrValA, csrRowPtrA, csrColIndA, B, ldb, beta, C, ldc)
...
.. py:method:: pycudalib.sparse.Sparse.csrmm2(transA, transB, m, n, k, nnz, alpha, descrA, csrValA, csrRowPtrA, csrColIndA, B, ldb, beta, C, ldc)
...
.. py:method:: pycudalib.sparse.Sparse.csrsm_analysis(transA, m, nnz, descrA, csrValA, csrRowPtrA, csrColIndA)
...
.. py:method:: pycudalib.sparse.Sparse.csrsm_solve(transA, m, n, alpha, descrA, csrValA, csrRowPtrA, csrColIndA, info, X, ldx, Y, ldy)
...
.. py:method:: pycudalib.sparse.Sparse.XcsrgeamNnz(m, n, descrA, nnzA, csrRowPtrA, csrColIndA, descrB, nnzB, csrRowPtrB, csrColIndB, descrC, csrRowPtrC)
...
.. py:method:: pycudalib.sparse.Sparse.csrgeam(m, n, alpha, descrA, nnzA, csrValA, csrRowPtrA, csrColIndA, beta, descrB, nnzB, csrValB, csrRowPtrB, csrColIndB, descrC, csrValC, csrRowPtrC, csrColIndC)
...
.. py:method:: pycudalib.sparse.Sparse.XcsrgemmNnz(transA, transB, m, n, k, descrA, nnzA, csrRowPtrA, csrColIndA, descrB, nnzB, csrRowPtrB, csrColIndB, descrC, csrRowPtrC)
...
.. py:method:: pycudalib.sparse.Sparse.csrgemm(transA, transB, m, n, k, descrA, nnzA, csrValA, csrRowPtrA, csrColIndA, descrB, nnzB, csrValB, csrRowPtrB, csrColIndB, descrC, csrValC, csrRowPtrC, csrColIndC)
...
.. py:method:: pycudalib.sparse.Sparse.csrgemm_ez(A, B, transA='N', transB='N', descrA=None, descrB=None, descrC=None)
    ...
    :py:class:`pycudalib.sparse.CudaCSRMatrix` matrices, and makes
    calls to :py:meth:`XcsrgemmNnz` and :py:meth:`csrgemm`.

   :param A: :py:class:`pycudalib.sparse.CudaCSRMatrix`
   :param B: :py:class:`pycudalib.sparse.CudaCSRMatrix`
   ...
   :return: :py:class:`pycudalib.sparse.CudaCSRMatrix`


Preconditioners
---------------

.. py:method:: pycudalib.sparse.Sparse.csric0(trans, m, descr, csrValA, csrRowPtrA, csrColIndA, info)
...
.. py:method:: pycudalib.sparse.Sparse.csrilu0(trans, m, descr, csrValA, csrRowPtrA, csrColIndA, info)
...
.. py:method:: pycudalib.sparse.Sparse.gtsv(m, n, dl, d, du, B, ldb)
...
.. py:method:: pycudalib.sparse.Sparse.gtsv_nopivot(m, n, dl, d, du, B, ldb)
...
.. py:method:: pycudalib.sparse.Sparse.gtsvStridedBatch(m, dl, d, du, x, batchCount, batchStride)
...
.. py:method:: pycudalib.sparse.Sparse.bsr2csr(dirA, mb, nb, descrA, bsrValA, bsrRowPtrA, bsrColIndA, blockDim, descrC, csrValC, csrRowPtrC, csrColIndC)
...
.. py:method:: pycudalib.sparse.Sparse.Xcoo2csr(cooRowInd, nnz, m, csrRowPtr)
...
.. py:method:: pycudalib.sparse.Sparse.csc2dense(m, n, descrA, cscValA, cscRowIndA, cscColPtrA, A, lda)
...
.. py:method:: pycudalib.sparse.Sparse.Xcsr2bsrNnz(dirA, m, n, descrA, csrRowPtrA, csrColIndA, blockDim, descrC, bsrRowPtrC)
...
.. py:method:: pycudalib.sparse.Sparse.csr2bsr(dirA, m, n, descrA, csrValA, csrRowPtrA, csrColIndA, blockDim, descrC, bsrValC, bsrRowPtrC, bsrColIndC)
...
.. py:method:: pycudalib.sparse.Sparse.Xcsr2coo(csrRowPtr, nnz, m, cooRowInd)
...
.. py:method:: pycudalib.sparse.Sparse.csr2csc(m, n, nnz, csrVal, csrRowPtr, csrColInd, cscVal, cscRowInd, cscColPtr, copyValues)
...
.. py:method:: pycudalib.sparse.Sparse.csr2dense(m, n, descr, csrVal, csrRowPtr, csrColInd, A, lda)
...
.. py:method:: pycudalib.sparse.Sparse.dense2csc(m, n, descrA, A, lda, nnzPerCol, cscVal, cscRowInd, cscColPtr)
...
.. py:method:: pycudalib.sparse.Sparse.dense2csr(m, n, descrA, A, lda, nnzPerRow, csrVal, csrRowPtr, csrColInd)
...
.. py:method:: pycudalib.sparse.Sparse.nnz(dirA, m, n, descrA, A, lda, nnzPerRowCol)
