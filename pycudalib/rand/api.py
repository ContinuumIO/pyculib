...
def uniform(size, dtype=np.float, device=False):
    ...
    .. seealso:: :py:meth:`pycudalib.rand.PRNG.uniform`
    '''
...
def normal(mean, sigma, size, dtype=np.float, device=False):
    ...
    .. seealso:: :py:meth:`pycudalib.rand.PRNG.normal`
...
def lognormal(mean, sigma, size, dtype=np.float, device=False):
    ...
    .. seealso:: :py:meth:`pycudalib.rand.PRNG.lognormal`
...
def poisson(lmbd, size, device=False):
    ...
    .. seealso:: :py:meth:`pycudalib.rand.PRNG.poisson`
    '''
...
def quasi(size, bits=32, nd=1, device=False):
    ...
    .. seealso:: :py:meth:`pycudalib.rand.QRNG.generate`
    '''
    if bits == 64:
        dtype = np.uint64
    elif bits == 32:
